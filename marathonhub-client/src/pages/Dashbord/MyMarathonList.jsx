...
const MyMarathonList = () => {
  ...
  return (
    ...
    <div className="p-6 bg-surfaceColor text-text min-h-screen">
      <h2 className="text-3xl font-bold mb-6 text-highlight">My Added Marathons</h2>
      ...
      <dialog id="update_modal" className="modal">
        <div className="modal-box bg-surfaceColor text-text max-w-lg">
          <h3 className="font-bold text-xl mb-4 text-highlight">Update Marathon</h3>
          <form onSubmit={handleUpdateSubmit} className="space-y-4">
            ...
            <input
              ...
              defaultValue={formatDateForInput(selectedMarathon?.startRegistrationDate)}
              className="input input-bordered w-full rounded-md bg-surfaceColor text-text  border-1 border-border"
              required
            />
             <label
            ...
            <input
              ...
              defaultValue={formatDateForInput(selectedMarathon?.endRegistrationDate)}
              className="input input-bordered w-full rounded-md bg-surfaceColor text-text  border-1 border-border"
              required
            />
             <label
            ...
            <input
              ...
              defaultValue={formatDateForInput(selectedMarathon?.marathonStartDate)}
              className="input input-bordered w-full rounded-md bg-surfaceColor text-text  border-1 border-border"
              required
            />
             <label
            ...
            <div className="modal-action">
              <button type="submit" className="btn bg-[#2a9d8f] text-white hover:bg-[#21867a]">
                Save Changes
              </button>
              <button
                type="button"
